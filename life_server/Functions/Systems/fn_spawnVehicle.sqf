...
[1,"Ihr Fahrzeug ist nun vorhanden und es ist versichert!"] remoteExecCall ["life_fnc_broadcast",_unit];
}else{
[1,"Ihr Fahrzeug ist vorhanden, aber nicht versichert!"] remoteExecCall ["life_fnc_broadcast",_unit];
};
serv_sv_use deleteAt _servIndex;
